import hashlib, os, platform, tarfile, codecs
...
configs = [
    VersionConfig(
        ...
        dylib_patches=[(0x8fd1, codecs.decode('E985000000', 'hex'))],
    ...
    VersionConfig(
        ...
        dylib_patches=[(0x98fb, codecs.decode('E97F000000', 'hex'))],
    ...
    VersionConfig(
        ...
        dylib_patches=[(0x9917, codecs.decode('E956010000', 'hex'))],
